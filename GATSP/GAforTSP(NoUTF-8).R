...
GA4TSP <- function(distant){
  ...
  for(i in (1:t)){
    ...
    plot(date, type = "l", ylab = "Average Fitness", xlab = "Iteration times", main = "The change of mean fitness with time")
  }
}
...
d <- read.table("C:/Users/asus/Desktop/R Project/GATSP/d.txt", quote="\"", comment.char="")
GA4TSP(d)
